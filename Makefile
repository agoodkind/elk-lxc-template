...
$(OUT_DIR)/install.sh: $(OUT_DIR) templates/install-header.sh templates/extract-install-logic.awk scripts/install-steps.sh scripts/post-deploy.sh scripts/rotate-api-keys.sh templates/install-footer.sh
